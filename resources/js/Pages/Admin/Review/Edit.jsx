                ...
                <div className="card">
                    <div className="card-body">
                        <div className='flex items-center justify-between'>
                            <div >
                                <h5 className="card-title">Review For <span className='text-gray-800 italic font-bold'>{review.business.company_name}</span></h5>
                            </div>
                        ...
                        <div className='p-4 bg-white border rounded mt-4'>
                            <div className=' pb-3 border-b border-b-2 flex items-center justify-between'>
