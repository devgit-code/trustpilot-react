...
const Category = ({categories, sub_categories, business_id}) => {
    ...
    const handleAddClick = () => {
        if (selectedOption) {
            ...
            router.post(route('admin.businesses.category.add', {business:business_id}), {
    ...
    const handleSetAsPrimary = (id) => {
        router.post(route('admin.businesses.category.primary', {business:business_id, category:id}));
    };

    const handleDelete = (id) => {
        router.delete(route('admin.businesses.category.remove', {business:business_id, category:id}));
    };
    ...
    return (
        <div className="card py-6 bg-white container-md mt-3">
