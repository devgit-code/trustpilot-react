...
const BlogList = ({ blogs}) => {
    ...
    return (
        <div className="container-md bg-white">
            ...
            <div className="relative flex items-center pt-3 mx-2">
                {/* flex gap-4 overflow-x-scroll-important md:overflow-hidden-important scroll-smooth */}
                <div className="flex lg:grid lg:grid-cols-4 lg:w-full gap-5 overflow-x-scroll-important lg:overflow-hidden-important scroll-smooth">
