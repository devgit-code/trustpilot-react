...
export default function Product({ product, company }) {
            ...
            <FrontendLayout>
                ...
                <div className='bg-whtie border-b '>
                    <div className='container-sm p-4 flex justify-center'>
                        <div className='max-w-screen-sm w-full flex items-center justify-between'>
                            ...
                            <div className='inline-flex items-center justify-center w-16 h-16 rounded border'>
                                <img
