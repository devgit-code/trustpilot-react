                        ...
                        primary_business_category && (
                            <>
                                <div className='flex items-center'>
                                    <Link href={route('categories.show', primary_business_category.sub_category.category.slug)}
                                ...
                                <Link href={route('categories.detail', {category:primary_business_category.sub_category.category.slug, sub_category:primary_business_category.sub_category.slug})}
