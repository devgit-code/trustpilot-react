...
function SearchSection() {
    return (
        <div className="relative flex items-center justify-center h-[70vh] bg-[#FCFBF3] overflow-hidden">
            {/* Background shapes */}
            <div className="absolute w-1/2 aspect-[1/1] inset-1/4 md:-top-[140%] -top-[40%] bg-[#FD791A] rounded-full animate-horizontal"></div>
...
<svg
        viewBox="0 0 100 100"
        className="animate-spin absolute md:-right-[25%] md:-bottom-[40%] -right-[10%] -bottom-[20%] w-1/3 aspect-[1/1]"
