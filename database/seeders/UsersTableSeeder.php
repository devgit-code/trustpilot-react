...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        if (Business::get()->count() == 0) {
            ...
            Business::create(array('website' => 'https://test.com', 'role' => 'admin', 'company_name' => 'Test', 'first_name' => 'Admin', 'last_name' => 'D', 'job_title' => 'Admin', 'company_email' => 'test@superadmin.com', 'is_approved' => 1, 'email_verified_at' => Carbon::now(), 'password' => Hash::make('root1234'), 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()));
